...
// // // // // func PrintSecondItem(s string) {
// // // // // 	words := strings.Split(s, "|")
// // // // // 	fmt.Println(words[1])
// // // // // }

// // // // // func main() {
// // // // // 	sentence := "Go|Python|JavaScript"

// // // // // 	PrintSecondItem(sentence)
// // // // // }


// // // // // // Now we will be using the strings.Contains for string manipulation
...
// // // // 	text := strings.Contains(word, "fun")
// // // // 	return text
// // // // }

// // // // func main()  {
// // // // 	fmt.Println(CheckWord("go is fun"))
// // // // }
...
// 👉 Verify that the string contains:
...
func CheckIfWordCo(s string) string {
	ch := rune(s[0])
...
func main()  {
	fmt.Println(CheckIfWordCo("G"))
	fmt.Println(CheckIfWordCo("o"))
	fmt.Println(CheckIfWordCo("1"))
	fmt.Println(CheckIfWordCo("!"))
}